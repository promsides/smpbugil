...
const jsonLd = {
        ...
        url: `https://smpbugil.pages.dev/v/${file.filecode}`,
        ...
        interactionStatistic: {
            ...
            interactionType: {
                '@type': `WatchAction`,
                target: `https://smpbugil.pages.dev/v/${file.filecode}`
            }  
        }
        }
        const jsonLd2 = {
        ...
        publisher: {
            '@type': 'Organization',
            name: `${SITENAME}`,
            logo: 'https://smpbugil.pages.dev/favicon.ico'},
            author: {
                '@type': 'Person',
                name: 'admin',
                url: 'https://smpbugil.pages.dev'
              },
        interactionStatistic: {
            '@type': `InteractionCounter`,
                userInteractionCount: `${file.views}`,
    ...
    return (
        ...
        {/* ... */}
            ...
            <Card className="mx-2 mb-8">
                ...
                <CardContent>
            <p>Video bokep indo terbaru viral {file.title} di {SITENAME} Video Bokep Indo Jepang Barat Terbaru bocil jilbab smp mama sma hijab abg colmek film tante hot twitter asia download live stw situs indonesia nonton link sd crot playbokep simontok smpbugil montok baru perawan anak kecil telegram selingkuh ojol cantik gay vidio lokal artis pelajar janda streaming jepang barat korea japan jav cina japanese china rusia arab india thailand hd anime hentai smpbugild gudang avtub pijat sotwe rumah pemerkosaan inggris xpanas pure tobrut vcs ngintip binor remaja yandex update perselingkuhan wiki raja full com porno indoh</p>
